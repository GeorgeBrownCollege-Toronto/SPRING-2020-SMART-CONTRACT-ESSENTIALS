## Manticore
Automatically find bugs in smart contracts.
...
#### Credits
- [HOW TO USE MANTICORE TO FIND BUGS IN SMART CONTRACTS](https://ethereum.org/en/developers/tutorials/how-to-use-manticore-to-find-smart-contract-bugs/)